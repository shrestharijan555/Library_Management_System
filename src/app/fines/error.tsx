...
export default function FinesError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Fines error boundary caught:", error);
  }, [error]);
        ...
        <CardContent className="p-6 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
              An error occurred while fetching financial fine records. Please try again.
            </p>
          </div>
